...
const contract = {
  id: 38076,
  address: '0xcfe68da812d627abcbd03a8ef5a669fbf08c4fb8' as const,
  contract_name: 'TokenGatedStageLogic',
  display_name: 'Token Gated Stage Logic',
  is_deprecated: false,
  is_proxy: false,
  proxy_to: false,
  created_at: 1765360008,
  abi: [
  {

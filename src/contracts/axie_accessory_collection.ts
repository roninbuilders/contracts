...
const contract = {
  id: 155,
  address: '0xac6a4cfea0dead2581b5d183b8bdc2b3ddcfc95f' as const,
  contract_name: 'AxieAccessoryCollection',
  display_name: 'Axie Accessory Collection',
  is_deprecated: false,
  is_proxy: false,
  proxy_to: false,
  created_at: 1671444424,
  abi: [
  {
    "type": "constructor",
  ...
  },
  {
    ...
    "outputs": [
      {
        "type": "uint128",
        "name": "_collectionTypeId"
      },
      {
        "type": "uint128",
        "name": "_typedCollectionId"
      }
    ]
  },
  {

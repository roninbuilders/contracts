...
const contract = {
  id: 36006,
  address: '0x971de0b52769a6e8a7647d076fa48c3741171e3b' as const,
  contract_name: 'EliteTokenPublicSale',
  display_name: 'Elite Token Public Sale',
  is_deprecated: false,
  is_proxy: false,
  proxy_to: false,
  created_at: 1751707319,
  abi: [
  {
    "type": "constructor",
    ...
    "inputs": [
      ...
      {
        "type": "uint256",
        "name": "_eliteAmountPerUSDCBaseUnit"
      },
      {
        "type": "uint256",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "type": "uint256",
        "name": "newEliteAmountPerUSDCBaseUnit"
      },
      {
        "type": "uint256",
        "name": "newMaxElite"
  ...
  {
    "name": "eliteAmountPerUSDCBaseUnit",
    "type": "function",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "type": "uint256",
        "name": "_newEliteAmountPerUSDCBaseUnit"
      },
      {
        "type": "uint256",

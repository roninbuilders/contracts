...
const abi = [
		...
		outputs: [
			{
				...
				internalType: 'struct GenesisHeroes721Vault.HeroZ[]',
				name: 'heroZInfo',
				type: 'tuple[]',
			},
		],
		...
		outputs: [
			{
				...
				internalType: 'struct GenesisHeroes721Vault.StakeHeroZGenesis[]',
				name: '',
				type: 'tuple[]',
			},
		],
	...
	},
	{
		...
		outputs: [
			{
				internalType: 'contract GenesisHeroes721',
				name: '',
				type: 'address',
			},
		],
	...
	},
	{
		inputs: [
			{
				internalType: 'contract MGold20Wallet',
...
const GENESIS_HEROES_721_VAULT_2: Contract<typeof abi> = {
	name: 'Genesis Heroes 721 Vault',
	address: '0x6c6d2e1fb926c692f086e15c4095879e5402ea45',
	is_deprecated: false,
	created_at: 1731050888,
	abi: abi,
}
export default GENESIS_HEROES_721_VAULT_2

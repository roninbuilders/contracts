...
const contract = {
  id: 27355,
  address: '0x6d7a33453403a9d94e0e2bdbe7aa9766e6169e16' as const,
  contract_name: 'RewardClaim',
  display_name: 'Reward Claim',
  is_deprecated: false,
  is_proxy: false,
  proxy_to: false,
  created_at: 1741333391,
  abi: [
  {
    "type": "constructor",
  ...
  {
    "name": "MysteryBoxClaimAuthorized",
    "type": "event",
    "inputs": [
      {
        "type": "address",
  ...
  {
    "name": "authorizeMysteryBoxClaims",
    "type": "function",
    "stateMutability": "nonpayable",
    "inputs": [
      {
  ...
  {
    "name": "authorizedMysteryBoxTokenIds",
    "type": "function",
    "stateMutability": "view",
    "inputs": [
      {

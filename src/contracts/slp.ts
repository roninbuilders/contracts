export const SLP = {
	...
	ABI: [
		{
			inputs: [{ internalType: 'uint256', name: '_dailyPotionLimit', type: 'uint256' }],
			payable: false,
		...
		{
			anonymous: false,
			inputs: [{ indexed: true, internalType: 'address', name: '_minter', type: 'address' }],
			name: 'MinterAdded',
			type: 'event',
		},
		{
		...
		{
			constant: false,
			inputs: [{ internalType: 'address[]', name: '_addedMinters', type: 'address[]' }],
			name: 'addMinters',
			outputs: [],
			payable: false,
			stateMutability: 'nonpayable',
		...
		},
		{
			constant: false,
			inputs: [
				{ internalType: 'contract IERC20Receiver', name: '_spender', type: 'address' },
				{ internalType: 'uint256', name: '_value', type: 'uint256' },
		...
		},
		{
			constant: false,
			inputs: [
				{ internalType: 'contract IERC20PayableReceiver', name: '_spender', type: 'address' },
				{ internalType: 'uint256', name: '_value', type: 'uint256' },
				{ internalType: 'bytes', name: '_data', type: 'bytes' },
			],
		...
		{
			constant: false,
			inputs: [{ internalType: 'address[]', name: '_removedMinters', type: 'address[]' }],
			name: 'removeMinters',
			outputs: [],
			payable: false,
			stateMutability: 'nonpayable',

	...
	},
	{
		...
		inputs: [
			...
			},
			{
				components: [
					{
						...
						internalType: 'struct ITimeboundEIP712.BaseRequest',
						name: 'baseRequest',
						type: 'tuple',
					},
					{
				...
				indexed: false,
				internalType: 'struct ISignatureMintERC1155.MintRequestWithParams',
...
const DYNAMIC_SUPPLY_LIMIT_ERC1155: Contract<typeof abi> = {

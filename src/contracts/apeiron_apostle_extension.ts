...
const contract = {
  id: 25692,
  address: '0x198aaf05d4bcfc2c19695891c10383f5728b3715' as const,
  contract_name: 'ApeironApostleExtension',
  display_name: 'Apeiron Apostle Extension',
  is_deprecated: false,
  is_proxy: false,
  proxy_to: false,
  created_at: 1739869606,
  abi: [
  {
    "type": "constructor",
  ...
  {
    "name": "apostleSpiritualMergeContract",
    "type": "function",
    "stateMutability": "view",
    "inputs": [],
    "outputs": [
  ...
  {
    "name": "getApostleDataAndSMProgress",
    "type": "function",
    "stateMutability": "view",
    "inputs": [
      {
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "type": "address",
        "name": "_apostleSpiritualMergeContract"
      }
    ],
    "outputs": []
  },

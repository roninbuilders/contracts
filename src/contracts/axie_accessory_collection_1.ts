	...
	},
	{
		...
		inputs: [
			...
			},
			{
				...
				indexed: false,
				internalType: 'struct IERC721Collection.CollectionMetadata',
				name: 'metadata',
				type: 'tuple',
			},
		],
...
const AXIE_ACCESSORY_COLLECTION_1: Contract<typeof abi> = {
	name: 'Axie Accessory Collection',
	address: '0xac6a4cfea0dead2581b5d183b8bdc2b3ddcfc95f',
	is_deprecated: false,
	created_at: 1671444424,
	abi: abi,
}
export default AXIE_ACCESSORY_COLLECTION_1

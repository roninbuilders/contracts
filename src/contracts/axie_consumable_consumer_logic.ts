...
const abi = [
	...
	},
	{
		...
		inputs: [
			{
				indexed: false,
				internalType: 'contract IAxieConsumableERC1155',
				name: 'consumableContract',
				type: 'address',
			},
		],
		name: 'ConsumableContractUpdated',
		type: 'event',
	},
	{
		anonymous: false,
...
const AXIE_CONSUMABLE_CONSUMER_LOGIC: Contract<typeof abi> = {

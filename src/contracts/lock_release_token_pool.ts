...
const LOCK_RELEASE_TOKEN_POOL: Contract<typeof abi> = {
	name: 'Lock Release Token Pool',
	address: '0xdf0b6a1db0405e89e7efa2f8e2a054cff569c1ef',
	is_deprecated: false,
	created_at: 1736523650,
	abi: abi,
}
export default LOCK_RELEASE_TOKEN_POOL

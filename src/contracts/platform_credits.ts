		...
		inputs: [
			{
				...
				internalType: 'struct PlatformCredits.SupportedToken[]',
				name: 'tokens',
				type: 'tuple[]',
			},
			{
		...
		inputs: [
			{
				...
				internalType: 'struct IPlatformCredits.ApprovalMsg',
				name: 'approvalMsg',
				type: 'tuple',
			},
			{
...
const PLATFORM_CREDITS: Contract<typeof abi> = {
	name: 'Platform Credits',
	address: '0x62f6d9026aee022c1f10fef48681343b2c03ec4e',
	is_deprecated: false,
	created_at: 1736440947,
	abi: abi,
}
export default PLATFORM_CREDITS

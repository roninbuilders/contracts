...
const contract = {
  id: 2934,
  address: '0xf5f10ba656fd800848a43feaa00cd88512783317' as const,
  contract_name: 'TransparentUpgradeableProxy',
  display_name: 'Reward Distributor Proxy For Duet Monster',
  is_deprecated: false,
  is_proxy: true,
  proxy_to: '0x30dee771de316fa67f8e04055b0e91ea00d2eebb',
  created_at: 1718599463,
  abi: [
  {
    "type": "constructor",
